    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      <div className="w-full max-w-sm rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        ...
        <div className="p-6 sm:p-8 border-b border-slate-200">
          ...
          <p className="mt-4 text-center text-xs font-semibold tracking-[0.22em] uppercase text-blamejaGreen">
            Blameja
          </p>

          <h1 className="mt-2 text-center text-xl sm:text-2xl font-bold text-slate-800">
            Најава
          </h1>

          <p className="mt-1 text-center text-xs text-slate-500">
            Внеси ги пристапните податоци што ти ги додели администраторот.
          </p>
        </div>
        ...
        <div className="p-6 sm:p-8">
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            {error && (
              <div className="text-xs text-blamejaRed bg-red-50 border border-red-100 rounded-md px-3 py-2">
                {error}
              </div>
            )}
            ...
            <div className="pt-2">
              <p className="text-[11px] text-center text-slate-400">
                Пристап имаат само корисници претходно додадени во системот.
              </p>
