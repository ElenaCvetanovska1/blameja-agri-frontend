...
export const ProductNameWithSuggestions = ({
  value,
  onChange,
  placeholder,
  loading,
  ...
  return (
    <div ref={wrapRef} className="relative space-y-2">
      ...
      <p className="text-[11px] text-slate-500">
        Ако избереш постоечки производ, системот ќе пополни PLU/баркод/цена/ДДВ. Ако внесуваш нов производ: избери
        категорија, внеси име и PLU.
      </p>
    </div>
  );
};
